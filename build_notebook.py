...
md(
    ...
    "## Streamlit app\n"
    "\n"
    "- https://superkart-deploy3-wj54597j97f5vjp-8502.app.github.dev\n"
    "\n"
    "## Backend API\n"
    "\n"
    "- https://superkart-deploy3-wj54597j97f5vjp-7860.app.github.dev\n"
    "\n"
    "The first visit to any of the `.app.github.dev` links above, direct or through "
    "the custom domain, shows a one-time GitHub notice reading \"You are about to "
    "access a development port served by someone's codespace.\" This is expected, "
    "it is GitHub's standard warning for any forwarded Codespace port, not a sign "
    "of anything wrong with this deployment. Click Continue to reach the app, the "
    "notice will not show again for the rest of that browser session."
)
